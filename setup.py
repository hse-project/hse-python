...
extensions = [
    ...
    Extension(
        "hse.limits",
        [str(PROJECT_PATH.joinpath("hse", f"hse_limits.{'pyx' if USE_CYTHON else 'c'}"))],
        libraries=["hse_kvdb"]
    )
]
...
setup(
    ...
    cmdclass=cmdclass,
    package_dir={"hse": str(PROJECT_PATH.joinpath("hse")), "hse.limits": str(PROJECT_PATH.joinpath("hse"))},
